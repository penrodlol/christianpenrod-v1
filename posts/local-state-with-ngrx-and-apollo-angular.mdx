---
id: 7a163357-b2b5-4584-9f47-7795f08a5ef3
...
description:
  ...
  NgRx ComponentStore.
tags: [Apollo-Angular, NgRx, GraphQL]
toc: true
published: true
publishedOn: 2021-05-01T00:00:00-0000
readTime: 15
github: 'https://github.com/penrodlol/local-state-with-ngrx-and-apollo-angular'
stackblitz: 'https://stackblitz.com/github/penrodlol/local-state-with-ngrx-and-apollo-angular'
---
...
<Disclaimer>
  ...
  <ExternalLink href="https://apollo-angular.com/docs/data/queries">
    other ways
  </ExternalLink>
  of performing a Query. Wrapping it within an Angular Service is only one of
  them. Feel free to perform your Query however you find it most convenient.
  Whether that be within the component itself or in the data store we'll later
  create, both of which are possible via Apollo Angular.
</Disclaimer>
...
<Disclaimer>
  Apollo Angular provides{' '}
  <ExternalLink href="https://apollo-angular.com/docs/data/mutations">
    other ways
  </ExternalLink>{' '}
  of performing a Mutation. Wrapping it within an Angular Service is only one of
  them. Feel free to perform your Mutation however you find it most convenient.
  Whether that be within the component itself or in the ComponentStore, both of
  which are possible via Apollo Angular.
</Disclaimer>
