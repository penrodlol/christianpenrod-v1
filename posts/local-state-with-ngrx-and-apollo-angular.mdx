...
<Disclaimer>
  ...
  <ExternalLink href="https://apollo-angular.com/docs/data/queries" underline>
    other ways
  </ExternalLink>
...
<Disclaimer>
  Apollo Angular provides&#32;
  <ExternalLink href="https://apollo-angular.com/docs/data/mutations" underline>
    other ways
  </ExternalLink> of performing a Mutation. Wrapping it within an Angular Service
  is only one of them. Feel free to perform your Mutation however you find it most
  convenient. Whether that be within the component itself or in the ComponentStore,
