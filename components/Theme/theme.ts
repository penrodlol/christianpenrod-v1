...
export const dark: DefaultTheme = {
  ...
  basic: { base: 'hsl(233deg 24% 76%)', hover: 'hsl(233deg 32% 73%)' },
  primary: { base: 'hsl(229deg 42% 69%)', hover: 'hsl(229deg 35% 62%)' },
  secondary: { base: 'hsl(39deg 100% 90%)', hover: 'hsl(39deg 88% 84%)' },
  tertiary: { base: 'hsl(264deg 81% 84%)', hover: 'hsl(264deg 41% 72%)' },
...
export const light: DefaultTheme = {
  ...
  basic: { base: 'hsl(233deg 68% 92%)', hover: 'hsl(233deg 78% 88%)' },
  primary: { base: 'hsl(229deg 61% 69%)', hover: 'hsl(229deg 50% 62%)' },
  secondary: { base: 'hsl(39deg 88% 84%)', hover: 'hsl(39deg 90% 81%)' },
  tertiary: { base: 'hsl(266deg 62% 83%)', hover: 'hsl(266deg 30% 75%)' },
